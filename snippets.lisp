...
(defmacro if-let (var test-expr pass-expr fail-expr)
  "If, but bind the result of the test to a variable in the scope of the
test pass expression. Wanted this a few times and I'm having a fun day 
learning about macros so why not?"
